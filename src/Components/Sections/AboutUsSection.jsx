...
const AboutUsSection = () => {
  ...
  return (
    ...
    <div id="about" className="bg-gradient-to-br from-slate-900 via-[#000] to-black pb-[30px]" >
      <PaddingWrapper>

        <div className="z-0 relative w-full py-[20px] xl:py-[100px] text-white grid grid-cols-1 xl:grid-cols-2 gap-4 md:gap-10">

          <div className="grid grid-rows-2 xl:grid-rows-3 grid-cols-2 gap-3 md:gap-8 h-[30vh] lg:h-[60vh] xl:h-[70vh] 
          mask-gradient-top mask-gradient-bottom mask-gradient-right mask-gradient-left">
              <div className="rounded-xl md:rounded-2xl row-span-2 xl:row-span-3 overflow-hidden">
                <img
                  src={grid_img_01}
                  alt={`grid_img_01`}
              ...
              <div className="rounded-xl md:rounded-2xl row-span-1.5 xl:row-span-2 overflow-hidden">
                <img
                  src={grid_img_02}
                  alt={`grid_img_02`}
                  className="z-10 w-full h-full object-cover cursor-pointer transform transition duration-500 hover:scale-110"
              ...
              <div className="rounded-xl md:rounded-2xl row-span-1.5 xl:row-span-1 overflow-hidden">
                <img
                  src={grid_img_03}
                  alt={`grid_img_03`}
                  className="z-10 w-full h-full object-cover cursor-pointer transform transition duration-500 hover:scale-110"
          ...
          <div className="flex flex-col items-center relative">
            ...
            <div className="w-full mb-8">
              ...
              <p className="text-[13px] md:text-[15px] font-[PoppinsRegular] mb-4 text-[#fff]/[0.6]">
              ...
              <p className="text-[13px] md:text-[15px] font-[PoppinsRegular] text-[#fff]/[0.6]">
          ...
          selectedImage && (
            <div className="h-screen w-full inset-0 fixed top-0 left-0 bg-black bg-opacity-75 flex items-center justify-center z-50 backdrop-blur-sm">
              <div className="w-full h-full relative flex justify-center items-center">
                <button
                  className="w-12 h-12 rounded-xl absolute top-4 right-4 md:top-8 md:right-8 text-white text-2xl 
